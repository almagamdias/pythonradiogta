                    ...
                    if (
                        ...
                        while (
                            ...
                            try:
                                ...
                                # Do not discard active_overlay_generation here.
                                #
                                # overlay_buffer may still contain samples that were
                                # decoded immediately before EOF. Those samples must
                                # still be mixed into the current output.
                                break
